...
kineval.initKeyEvents = function init_keyboard_events() {
    document.addEventListener('keydown', function(e) {kineval.handleKeydown(e.keyCode); }, true);
}
...
/*
    ...
    if ( keyboard.pressed("z") ) {
        ...
        // camera will reset once view command given through mouse
        // not sure why statements below and camera.lookAt() do not work
