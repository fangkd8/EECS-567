...
kineval.startingPlaceholderInit = function startingPlaceholderInit() {
    ...
    */
    ...
    waveFrequency = 0.3;  // could be interesting to modify this variable
...
kineval.startingPlaceholderUserInput = function startingPlaceholderUserInput() {
    ...
    */
    ...
    // STENCIL: update the global spacing variable
		...
		if(spacingGlobal-0<0.0001)
			textbar.innerHTML = "My parts has been together.";
		if(waveAmplitude-0<0.0001)
			textbar.innerHTML = "I yield. I am not moving now.";
		if(waveFrequency-0<0.0001)
			textbar.innerHTML = "I yield. I am not moving now.";
    }
}
